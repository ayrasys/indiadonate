jQuery( document ).ready(function() {
	...
	// send rejection
	jQuery('#btnSendMailRejection').click(function(){

		var txtNarative=jQuery('#txtRejectionReason').val();
...
jQuery('#btnSendMailDueDiliA').click(function(){
