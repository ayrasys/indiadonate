              ...
              <tr>
                  ...
                  <td><?php
                   ...
                   if($row->ngo_done==2){
                    ...
                    <td><?php echo date("j F, Y", strtotime($row->approval_on)); ?></td>
...
<div class="container">
  ...
  <fieldset>
      <div >
          ...
          <textarea required  id="form2-text" name="abut_org" required="required" type="textarea" value="" required placeholder="" data-rule-required="true" data-msg-required="Required" ></textarea>
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- ------------------ Our Vision ---------------------- -->
        <div >
          ...
          <textarea required id="form3-text" name="our_vis" required="required" type="textarea" value="" placeholder="" data-rule-required="true" data-msg-required="Required" ></textarea>
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    <!-- --------------- End ------------------- -->
     <!-- ----------------- Our Mission ------------------------ -->
        <div >
          ...
          <textarea required  id="form4-text" name="our_mis" required="required" type="textarea" value="" placeholder="" data-rule-required="true" data-msg-required="Required" ></textarea>
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
                    ...
                    <table cellspacing='0' cellpadding='0' width='800' class='w320'>
                      <tr>
                        <td class='free-text pull-left'>
                         ...
                         &#39;A movement to change live's-Indiadonates.
...
$subject = 'Due Deligece Verification';
