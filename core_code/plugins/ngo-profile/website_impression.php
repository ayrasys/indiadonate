...
$kv_errors= array();
if('POST' == $_SERVER['REQUEST_METHOD'] && isset($_POST['submit_form_narative']))  {
	 ...
	 if (empty($errors)) {
      ...
      wp_update_attachment_metadata( $attach_id, $attach_data );
          ...
          //  die(json_encode(array('type'=>'error',  'error' => 1)));
            ...
            $PROJECTDETAIL=$_POST['txtProjectDetails'];
            $NGONAME=$_POST['txtNGO_name'];
            $txtNGO_ID=$_POST['txtNGO_ID'];
...
<!--- Include the above in your HEAD tag ---------->
    ...
    <div class="page-header">
        <h1>Website Impression <span class="pull-right label label-default">:)</span></h1>
    </div>
    <div class="row">
    	<div class="col-md-12">
 ...
 <div class="container-fluid">
        ...
        <tbody>
          ...
          foreach( $result as $printRow ){
            ...
            <tr>
                ...
                <td><?php echo $printRow->country_name?></td>
                <td><?php echo $printRow->city?></td>
                  <td><?php echo $printRow->ip_address?></td>
                <td><img width="60" src="<?php echo $printRow->country_flag?>"></td>
  ...
  <!-- Modal -->
<div id="myModalAddNarative" class="modal fade" role="dialog">
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Project Narative</h4>
      </div>
...
<input name="txtNGO_ID" type="hidden" value="<?php echo $result_arr->nguser_id ?>" required placeholder="Your Name">
   ...
   <input name="email" type="hidden" value="<?php echo $result_arr->email_id; ?>" required placeholder="Your Email">
            ...
            <div class = "form-group">
               ...
               <input name="txtProjectName" type = "text" class = "form-control"
            ...
            <div class = "form-group">
               <label for = "exampleInputPassword1">Project Details</label>
                    <textarea id="summernote"  name="txtProjectDetails"></textarea>
            </div>
            <div class = "form-group">
            ...
            <input class = "btn btn-primary"  id="submit" name="submit_form_narative" type="submit" value="Submit">
  ...
  var table = $('#exampleNarative').DataTable( {
      orderCellsTop: true,
      fixedHeader: true
  } );
