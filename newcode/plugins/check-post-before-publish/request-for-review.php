...
function send_emails_on_new_event($post){
  ...
  //$emails = "ashishk@techbrise.com, akmashish15@gmail.com";
   ...
   $message = "Hi Admin, There is new project proposal:\n{$url}";
   ...
   wp_mail( $emails, "New Project Proposal: {$url}", $message );
...
function send_emails_on_publish($post){
                    ...
                    <table cellspacing='0' cellpadding='0' width='800' class='w320'>
                      <tr>
                        <td class='free-text pull-left'>
                          ...
                          <p>Your Project is live on the portal. To view your project, <a href='{$url}'>click here</a> Start popularising it in your network and beyond!!</p>
  ...
  wp_mail( $ngo_mail, "Your Project is now live!: {$title}", $message );
}
