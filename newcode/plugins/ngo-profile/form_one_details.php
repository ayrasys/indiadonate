...
<?php
     ...
     if( isset( $_GET['nunid'] ) ){
      ...
      // echo" <center><h1> NGO Form- 1 details</h1></center>";
       ...
       <center><h1> Board Member</h1></center>
         ...
         $idsa = $_GET['nunid']; //Array ( [approve] => yes [useridss] => 323 )
         ...
         $wpdb->update(
          ...
          array( 'nguser_id' => $idsa )
                       ...
                       <table cellspacing='0' cellpadding='0' width='800' class='w320'>
                         <tr>
                           <td class='free-text pull-left'>
                             Dear Mr/Ms. <strong>  $ngo_user_last_name </strong>

                             <p>Greetings from Indiadonates!</p>

                             <p>Thank you for showing your interest. Your details has been verified. In order to proceed further, we would request you to fill in the online form. This needs activation of your account.</p>
             ...
             //update status of wp_ngo_profile
     ...
     ?>
   <center><h2>Form one details</h2></center>
   ...
   <table id="example_userlist" class="display" style="width:100%">
           ...
           <tbody>
             <?php
              ...
              WHERE wp_usermeta.meta_key = 'wp_capabilities' and wp_usermeta.meta_value like '%ngo_charitable%' group BY wp_users.id desc " );
              foreach( $result as $print ){
                //print_r( $print );
                  $ngo_form_id = $print->ID;
                  $aaj=get_user_meta( $ngo_form_id, 'org_name', true );

                ?>
                       <tr>
                       <td class="th-ngoname"><?php echo $ngo_form_id;?></td>
                         <td class="th-ngoname"><?php echo $aaj;?></td>
                         ...
                         <td><?php
                          ...
                          if ( empty( $result ) ) {
                           ...
                           $ngo_status_btn = $ngo->form_one_approved;
                           ...
                           <td><?php
                            ...
                            $ajdate_app= date("j F, Y", strtotime($ngo->approval_on));
