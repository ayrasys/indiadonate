...
$kv_errors= array();
if('POST' == $_SERVER['REQUEST_METHOD'] && isset($_POST['submit_form_support']))  {
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        global $wpdb;
        $table_name = "wp_ngo_support";
        $result_arr = $wpdb->get_row( "SELECT * FROM $table_name where ngo_id = '$usid'" );
        // echo "<pre>";
...
<input name="txtNGO_ID" type="hidden" value="<?php echo $usid; ?>" required placeholder="Your Name">
   ...
   <input name="email" type="hidden" value="<?php echo $result_arr->email_id; ?>" required placeholder="Your Email">
            ...
            <input class = "btn btn-primary"  id="submit" name="submit_form_support" type="submit" value="Submit">
