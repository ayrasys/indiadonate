...
function ngo_profile_menu(){
  ...
  if ( in_array("administrator", $user_roles) ){
    add_menu_page( 'NGO profile Page', 'NGOs List', 'edit_posts', 'ngo_profile_form', 'tbs_ngo_profile_form','',10);
    add_submenu_page( 'ngo_profile_form', 'Form one details', 'Form one details', 'edit_posts','ngo_user_details', 'tbs_ngo_form_one_details');
    add_submenu_page( 'ngo_profile_form', 'Website Impression', 'Website Impression', 'edit_posts','ngo_user_details_webIMp', 'tbs_ngo_form_one_details_');
    add_submenu_page( 'ngo_profile_form', 'Project Narrative', 'Project Narrative', 'edit_posts','ngo_project_narrative', 'tbs_ngo_form_one_details_k');

    add_menu_page( 'Support List', 'NGO Support', 'edit_posts', 'ngo_support_list', 'ngo_support_function','',12);

     function ngo_support_function(){
       include 'ngo_support_admin.php';
     }
     function tbs_ngo_form_one_details_(){
      include 'website_impression.php';
     }

     function tbs_ngo_form_one_details_k(){
      include 'ngo_narrative.php';
     }
  ...
  //   add_menu_page( 'ngo_profile_form', 'support', 'manage_options', 'example', 'display_text', 'need a uri to your image here!!', 6  );
  //add_submenu_page( 'ngo_profile_form', 'Support', 'Support', 'edit_posts','edit-profile', 'redirect_page');

     //https://indiadonate.sahajapps.com/support/create-ticket/
    ...
    if( $permission_grnt == "yes" ){
      ...
      add_submenu_page( 'ngo_projects_page', 'Project Narative', 'Project Narative','edit_posts','add_new_projects5', 'ngo_projects_page_narative');


    }
    add_menu_page( 'Support', 'Support', 'edit_posts', 'ngo_support', 'ngo_projects_page_form_support','',12);
    function ngo_projects_page_form_support(){
     include 'ngo_support.php';
    }

    function ngo_projects_page_narative(){
    include 'project_narative.php';
...
function redirect_page(){
  ...
  wp_redirect('https://indiadonate.sahajapps.com/support/create-ticket/');
}
...
function tbs_edit_profiles(){
  //echo "Ngo will edit the profies here.";
   ...
   if( $success ){
          $message = "Your Profile is Updated. please reload to see the changes";
              ...
              echo "<script type='text/javascript'>window.location.href = 'admin.php?page=ngo_profile_form'</script>";
      }else{
  ...
  <form class="edit-form" method="post">
    ...
    <div class='field-edit' style="vertical-align: top;">
      ...
      <textarea id="field-edit-textf" required  minlength="1" maxlength="400" name="abut_org" value="<?php echo $print->about_org;?>"><?php echo $print->about_org;?></textarea>
    </div>
    <div class='field-edit' style="vertical-align: top;">
      <label>Our Vision</label>
      <textarea id="field-edit-textf" required  minlength="1" maxlength="400" name="our_vis"><?php echo $print->ngo_vision;?></textarea>
    </div>
    <div class='field-edit' style="vertical-align: top;">
      <label>Our Mission</label>
      <textarea id="field-edit-textf" required  minlength="1" maxlength="400" name="our_mis" value="<?php echo $print->ngo_mission;?><"><?php echo $print->ngo_mission;?></textarea>
    </div>
...
//ajcode to save add board member details
...
//ajcode to save add board member details
   ...
   if( $success ){
                    ...
                    <table cellspacing='0' cellpadding='0' width='800' class='w320'>
                      <tr>
                        <td class='free-text pull-left'>
                          Dear Mr/Ms.<strong>  $user_last_name </strong>
                          <p>Thanks for filling all the details!</p>
                          <p>As part of the verification process, we would like to conduct a due diligence of your organisation.</p>
                          <p>This will broadly cover the processes related to financial management system, legal compliances</p>
                          &amp; related governance
    ...
    $ngo_form_Second_link_ngo = admin_url('/admin.php?page=ngo_profile_form&nid="'.$uid.'"');
    $ajHTML="
    New NGO profile link is as below <br>
    '.$ngo_form_Second_link_ngo.'
    ";
    // wp-admin/admin.php?page=ngo_profile_form&nid=374
    wp_mail( $email_id, "Verification Process initiated!", $ngo_message , $ngo_headers);
    wp_mail('info33@yopmail.com', "NGO Final Submittion", $ajHTML , $ngo_headers);
...
thead input {
          ...
          <?php
             ...
             foreach ($result as $key => $row) {
              ...
              <tr>
                  <td><?=$row->nguser_id?></td>
                  <td><?=$row->org_name?></td>
                  <td><?php echo date("j F, Y", strtotime(get_userdata($row->nguser_id)->user_registered)); ?></td>
                  <td><?php echo date("F", strtotime(get_userdata($row->nguser_id)->user_registered)); ?></td>
                  <?php $ngo_status_btn = $row->approval_status;
                  ...
                  <td><?php
                   ...
                   if($row->ngo_done==2){
                    ...
                    <td><?php
                   $ajdate_app=date("j F, Y", strtotime($row->approval_on));

                    if($ajdate_app=='1 January, 1970'){
                      echo '';
                    }else{
                      echo $ajdate_app;
                    }
                  ...
                  <td><a href="<?php echo get_admin_url();?>admin.php?page=ngo_profile_form&nid=<?php echo $row->nguser_id; ?>" class="btn btn-info">View Details</a></td>
              </tr>
              <?php
             }
             ?>
  ...
  <div class="updated vc_license-activation-notice" id="vc_license-activation-notice"><p>Hey Super Admin, to view the detail of NGO, please click on the view details.</p></div>
      <div class="profrow">
    <?php /*
    global $wpdb;
    $table_name = "wp_ngo_profile";
...
<script>
    ...
    jQuery('#example_userlist thead tr').clone(true).appendTo( '#example_userlist thead' );
    jQuery('#example_userlist thead tr:eq(1) th').each( function (i) {
        var title = jQuery(this).text();
        jQuery(this).html( '<input type="text" placeholder="Search '+title+'" />' );
...
?>
  ...
  <fieldset>
    ...
    <!-- ----------------------- End ----------- -->
        ...
        <div >
          ...
          <input id="" name="legal_name" type="text" value="" placeholder="Enter Name" data-rule-required="" data-msg-required="" >
        </div>
    <!-- ----------------------- End ----------- -->
    <!-- ----------- Acronym -------- -->
        <div >
          <label for=" "><strong>Acronym (if any)</strong></label>
          <input id="" name="acronym"  type="text" value="" placeholder="Enter Acronym" >
          <!--<span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span> -->
        </div>
    ...
    <!-- ----------- PIN Number -------- -->
      <div >
        ...
        <input id="" name="pin_number" required="required" type="number"  style="height: 40px;" value="" placeholder="Enter PIN code" data-rule-required="true" data-msg-required="Required" >
        <span class="error1" style="display: none;">
            <i class="error-log fa fa-exclamation-triangle"></i>
        </span>
      </div>
        ...
        <div class="cat-tblfed">
          <div class="tblfed-rw">
            <div class="tblfed-rwTitle"><strong>Chief Functionary</strong></div>
              <div class="tblfed-val">
                <input id="" name="ct_contact" type="text" value="" style="border: transparent;" placeholder="Enter Name" data-rule-required="true" data-msg-required="*">
                  <span class="error1" style="display: none;">
                  <i class="error-log fa fa-exclamation-triangle"></i>
                  </span>
              </div>
            <div class="tblfed-val">
              <input id="" name="ct_desig" style="border: transparent;" type="text" value="" placeholder="Enter Designation" data-rule-required="true" data-msg-required="*">
                <span class="error1" style="display: none;">
                <i class="error-log fa fa-exclamation-triangle"></i>
                </span>
            </div>
            <div class="tblfed-val">
              <input id="" name="ct_email" style="border: transparent;" type="email" value="" placeholder="Email" data-rule-required="true" data-msg-required="*">
                <span class="error1" style="display: none;">
                <i class="error-log fa fa-exclamation-triangle"></i>
                </span>
            </div>
            <div class="tblfed-val">
              <input id="" name="ct_landline" style="border: transparent; height: 40px;" type="number" value="" placeholder="Landline No." data-rule-required="true" data-msg-required="*" >
                <span class="error1" style="display: none;">
                <i class="error-log fa fa-exclamation-triangle"></i>
                </span>
            </div>
            <div class="tblfed-val">
              <input id="" name="ct_mobile" style="border: transparent; height: 40px;" type="number" value="" placeholder="Mobile no" data-rule-required="true" data-msg-required="*" >
                <span class="error1" style="display: none;">
                <i class="error-log fa fa-exclamation-triangle"></i>
                </span>
            </div>
          ...
          <div class="tblfed-rw">
            <div class="tblfed-rwTitle"><strong>Alternate Contact Person</strong></div>
              <div class="tblfed-val">
                <input id="" name="rc_name" style="border: transparent;" type="text" value="" placeholder="Enter Name"  data-rule-required="" data-msg-required="">
                  <!--<span class="error1" style="display: none;">
                  <i class="error-log fa fa-exclamation-triangle"></i>
                  </span> -->
              </div>
            <div class="tblfed-val">
              <input id="" name="rc_desig" style="border: transparent;" type="text" value="" placeholder="Enter Designation" data-rule-required="" data-msg-required="">
                <!--<span class="error1" style="display: none;">
                <i class="error-log fa fa-exclamation-triangle"></i>
                </span>-->
            </div>
            <div class="tblfed-val">
              <input id="" name="rc_email" style="border: transparent;" type="email" value="" placeholder="Email" data-rule-required="" data-msg-required="">
                <!-- <span class="error1" style="display: none;">
                <i class="error-log fa fa-exclamation-triangle"></i>
                </span> -->
            </div>
            <div class="tblfed-val">
              <input id="" name="rc_landline" style="border: transparent; height: 40px;" type="number" value="" placeholder="Landline No." data-rule-required="" data-msg-required="" >
                <!--<span class="error1" style="display: none;">
                <i class="error-log fa fa-exclamation-triangle"></i>
                </span> -->
            </div>
            <div class="tblfed-val">
              <input id="" name="rc_mobile" type="number" value="" placeholder="Mobile No." data-rule-required="" data-msg-required="*" style="border: transparent; height: 40px;">
            </div>
          </div>
          <div class="tblfed-rw">
            <div class="tblfed-rwTitle"><strong>Fundraising Officer (if any)</strong></div>
              <div class="tblfed-val">
                <input id="" name="frc_name" type="text" value="" placeholder="Enter Name" style="border: transparent;">
                  <span class="" style="display: none;">
                  <i class="error-log fa fa-exclamation-triangle"></i>
                  </span>
              </div>
            <div class="tblfed-val">
              <input id=" " name="frc_desig" type="text" value="" placeholder="Enter Designation" style="border: transparent;">
                <span class="" style="display: none;">
                <i class="error-log fa fa-exclamation-triangle"></i>
                </span>
            </div>
            <div class="tblfed-val">
              <input id="" name="frc_email" type="email" value="" placeholder="Email" style="border: transparent;">
                <span class="" style="display: none;">
                <i class="error-log fa fa-exclamation-triangle" style="border: transparent;"></i>
                </span>
            </div>
            <div class="tblfed-val">
              <input id=" " name="frc_landline" type="number" value="" placeholder="Landline No." style="border: transparent; height: 40px;">
                <span class="error1" style="display: none;">
                <i class="error-log fa fa-exclamation-triangle"></i>
                </span>
            </div>
            <div class="tblfed-val">
              <input id=" " name="frc_mobile" type="number" value="" placeholder="Mobile No." style="border: transparent; height: 40px;">
                <span class="" style="display: none;">
                <i class="error-log fa fa-exclamation-triangle"></i>
                </span>
            </div>
          ...
          <div class="tblfed-rw">
            <div class="tblfed-rwTitle"><strong>Finance Manager</strong></div>
              <div class="tblfed-val">
                <input id=" " name="ac_name" type="text" value="" placeholder="Enter Name" style="border: transparent;">
                  <span class="" style="display: none;">
                  <i class="error-log fa fa-exclamation-triangle"></i>
                  </span>
              </div>
            <div class="tblfed-val">
              <input id=" " name="ac_desig" type="text" value="" placeholder="Enter Designation" style="border: transparent;">
                <span class="" style="display: none;">
                <i class="error-log fa fa-exclamation-triangle"></i>
                </span>
            </div>
            <div class="tblfed-val">
              <input id="" name="ac_email" type="email" value="" placeholder="Email" style="border: transparent;">
                <span class="error1" style="display: none;">
                <i class="error-log fa fa-exclamation-triangle"></i>
                </span>
            </div>
            <div class="tblfed-val">
              <input id="" name="ac_landline" type="number" value="" placeholder="Landline No." style="border: transparent; height: 40px;">
                <span class="" style="display: none;">
                <i class="error-log fa fa-exclamation-triangle"></i>
                </span>
            </div>
            <div class="tblfed-val">
              <input id="" name="ac_mobile" type="number" value="" placeholder="Mobile No." style="border: transparent; height: 40px;">
                <span class="" style="display: none;">
                <i class="error-log fa fa-exclamation-triangle"></i>
                </span>
            </div>
  ...
  <table padding="10">
    <tr>
        ...
        <div class="form-uplod" style="margin-bottom: 20px; padding-top: 10px;">
              <div class="container-upload">
                <div class="file-upload-wrapper-al" data-text="Select your file!">
                  ...
                  <p class="description"><button type="button" class="button wp-generate-pw hide-if-no-js" name="borad_member" id="borad_member_report_id"><strong>Add Board Member Details</strong></button></p>
                </div>
            </div>
        </div>
      </td>
      ...
      <div class="form-uplod" style="margin-bottom: 10px;">
            <div class="container-upload">
              <div class="file-upload-wrapper-al" data-text="Select your file!">
  ...
  <!-- board member details repeater -->
<div class="container">
  <div class="field_wrapper">
  <div class="row" style="1px solid #00000">
  <div class="col-md-2 col-sm-12" ><input type="text" name="txtname[]" placeholder='Name' class="form-control" ></div>
  <div class="col-md-2 col-sm-12"><input type="text" name="desig[]" placeholder='Designation' class="form-control" ></div>
  <div class="col-md-2 col-sm-12"><input type="text" name="tenure[]" placeholder='Tenure' class="form-control" ></div>
  <div class="col-md-2 col-sm-12"><input type="text" name="occup[]" placeholder='Occupation' class="form-control" ></div>
  <div class="col-md-3 col-sm-12"><input type="text" name="relation[]" placeholder='Relationship with Board' class="form-control" ></div>
  ...
  <fieldset>
    ...
    <h2 class="frm-two-head">Non FCRA Account:</h2>
       ...
       <div >
          ...
          <input id="" name="nfcra_name" type="text" value=""  placeholder="Enter Bank Name"  >
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- ---------------- Bank Branch Address ------------------- -->
      <div >
          ...
          <input id="" name="nfcra_branch" type="text" value=""  placeholder="Branch Name">
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
      </div>
    ...
    <!-- -------------------Account Number---------------------- -->
        <div >
          ...
          <input id="" name="nfcra_numb" type="text" value=""  placeholder="Account Number">
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- ----------------- Name of Account---------------- -->
        <div >
          ...
          <input id="" name="nfcra_acct" type="text" value=""  placeholder="Name of Account">
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- ------------------MICR number--------------------- -->
        <div >
          ...
          <input id="" name="nfcra_nmb" type="text" value="" placeholder="MICR" >
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- ------------------SWIFT Code----------------------- -->
        <div >
          ...
          <input id="" name="nfcra_swift" type="text" value="" placeholder="SWIFT Code"  >
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- -----------------IFSC CODE-------------------- -->
        <div >
          ...
          <input id="" name="ifsc_nfcra" type="text" value="" placeholder="IFSC Code" >
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <h2 class="frm-two-head">FCRA Account:</h2>
       ...
       <div >
          <label for=" "><strong>Bank Name</strong></label>
          <input id="" name="fcra_name" type="text" value="" placeholder="Bank Name" >
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- ---------------- Bank Branch Address ------------------- -->
      <div >
          <label for=" "><strong>Branch Name</strong></label>
          <input id="" name="fcra_branch" type="text" value="" placeholder="Branch Name" >
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
      </div>
     ...
     <!-- -------------------Account Number---------------------- -->
        <div >
          <label for=" "><strong>Account Number</strong></label>
          <input id="" name="fcra_numb" type="text" value="" placeholder="Account  Number"  >
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- -----------------Name of Account---------------- -->
        <div >
          <label for=" "><strong>Name of Account</strong></label>
          <input id="" name="fcra_acct" type="text" value="" placeholder="Name of Account" >
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
  ...
  <fieldset>
      <div >
          ...
          <textarea required  id="form2-text" name="abut_org"  type="textarea"   placeholder="" data-rule-required="true" data-msg-required="Required" ></textarea>
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- ------------------ Our Vision ---------------------- -->
        <div >
          ...
          <textarea required id="form3-text" name="our_vis"  type="textarea"  placeholder="" data-rule-required="true" data-msg-required="Required" ></textarea>
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    <!-- --------------- End ------------------- -->
     <!-- ----------------- Our Mission ------------------------ -->
        <div >
          ...
          <textarea required  id="form4-text" name="our_mis"  type="textarea"  placeholder="" data-rule-required="true" data-msg-required="Required" ></textarea>
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
        ...
        <div >
          ...
          <textarea id="form5-text" name="our_story"  type="textarea" value="" placeholder="" data-rule-required="true" data-msg-required="Required" ></textarea>
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
     ...
     //echo $id;
        ...
        <?php
          //update the form 2
            if( isset( $_POST['edit_details'] ) ){
              ...
              //Update user meta
              $ng_id = $_GET['nid'];
              update_user_meta( $ng_id, 'org_name', $ngo_name );
              $user_data44 = wp_update_user( array( 'display_name' => $ngo_name) );
      ...
      <div class="ngo_details">
          <div class="ngo_prof_details_l">
		    ...
		    <h3>Download Documents</h3>
              ...
              <div class="file-upload-wrapper-al edit_show" data-text="Select your file!">
                  ...
                  <p class="description"><button type="button" class="button wp-generate-pw hide-if-no-js" name="edit_fcra_doc" id="tbs_edit_fcra_id"><strong>FCRA </strong></button></p>
              </div>
              ...
              <p class="edit_hide">
                ...
                <?php if( $print->socity_doc == "" ){ ?>
                    <a href="<?php echo $print->socity_doc; ?>" target="_blank" style="pointer-events: none;"><i class="fa fa-file-pdf-o fa-lg" aria-hidden="true" style="color:#0073aa61;">Society Doc  </i></a>
                <?php } else{ ?>
                    <a href="<?php echo $print->socity_doc; ?>" target="_blank"><i class="fa fa-file-pdf-o fa-lg" aria-hidden="true" style="color:#0073aa;"> Society Doc </i></a>
                <?php } ?>
              </p>
              <p class="edit_hide">
              <?php if( $print->section_fcra_doc == "" ){ ?>
                    <a href="<?php echo $print->section_fcra_doc; ?>" target="_blank" style="pointer-events: none;"><i class="fa fa-file-pdf-o fa-lg" aria-hidden="true" style="color:#0073aa61;"> FCRA</i></a>
                <?php } else{ ?>
                    <a href="<?php echo $print->section_fcra_doc; ?>" target="_blank"><i class="fa fa-file-pdf-o fa-lg" aria-hidden="true" style="color:#0073aa;"> FCRA</i></a>
                <?php } ?>

                <?php if( $print->ngo_annul_report == "" ){ ?>
                    <a href="<?php echo $print->ngo_annul_report; ?>" target="_blank" style="pointer-events: none;"><i class="fa fa-file-pdf-o fa-lg" aria-hidden="true" style="color:#0073aa61;"> Annual Report</i></a>
                <?php } else{ ?>
                    <a href="<?php echo $print->ngo_annul_report; ?>" target="_blank"><i class="fa fa-file-pdf-o fa-lg" aria-hidden="true" style="color:#0073aa;"> Annual Report</i></a>
                <?php } ?>
              ...
              <?php if( $print->audited_finance_doc == "" ){ ?>
                    <a href="<?php echo $print->audited_finance_doc; ?>" target="_blank" style="pointer-events: none;"><i class="fa fa-file-pdf-o fa-lg" aria-hidden="true" style="color:#0073aa61;"> Audited Financial Statement</i></a>
                <?php } else{ ?>
                    <a href="<?php echo $print->audited_finance_doc; ?>" target="_blank"><i class="fa fa-file-pdf-o fa-lg" aria-hidden="true" style="color:#0073aa;"> Audited Financial Statement </i></a>
              <?php } ?></p>
          ...
          <div class="field_wrapper ">
                <?php
                global $wpdb;
                $table_name = "wp_board_member";
                $usida=$_GET['nid'];
                $result = $wpdb->get_results( "SELECT * FROM $table_name where user_id =  '$usida'" );
                $i=0;
                ...
                foreach ($result as $key => $RowData) {
                  ...
                  ?>
                  <div class="row">
                  <div class="col-md-2 col-sm-12"><input value ="<?php echo $RowData->name ?>"  type="text" name="txtname[]" placeholder='Name' class="form-control" ></div>
                  <div class="col-md-2 col-sm-12"><input value ="<?php echo $RowData->designation ?>"  type="text" name="desig[]" placeholder='Designation' class="form-control" ></div>
                  <div class="col-md-2 col-sm-12"><input value ="<?php echo $RowData->tenure ?>" type="text" name="tenure[]" placeholder='Tenure' class="form-control" ></div>
                  <div class="col-md-2 col-sm-12"><input value ="<?php echo $RowData->occupation ?>"  type="text" name="occup[]" placeholder='Occupation' class="form-control" ></div>
                  <div class="col-md-3 col-sm-12"><input <input value ="<?php echo $RowData->relationship ?>" type="text" name="relation[]" placeholder='Relationship with Board' class="form-control" ></div>
                  <?php
                  if($i>1){
                    ?>
                    <a href="javascript:void(0);" class="remove_button" title="Remove field">  <img src="http://demos.codexworld.com/add-remove-input-fields-dynamically-using-jquery/remove-icon.png"></a>

                    <?php
                  }else{
                    ?>
                      <a href="javascript:void(0);" class="add_button_admin" title="Add field"><img src="http://demos.codexworld.com/add-remove-input-fields-dynamically-using-jquery/add-icon.png"/> </a>
                    <?php
                  }
                  ?>
            ...
            // 	"
            // 	update  wp_ngo_profile set approval_status='yes' where nguser_id =$ng_id
            //
            // 	"
            // );
             $success = $wpdb->update(
            	'wp_ngo_profile',
            	array(
            		'approval_status' => 'yes',	// string

            	),
            	array( 'nguser_id' => $ng_id ),
            	array(
            		'%s',	// value1
                ...
                <td align='center' valign='top' width='100%' style='background-color: #f7f7f7;' class='content-padding'>
                  <center>
                    <table cellspacing='0' cellpadding='0' width='800' class='w320'>
                      <tr>
                        <td class='free-text pull-left'>
                          Dear Mr/Ms. <strong>$last_name</strong>

                          <p>Greetings from Indiadonates!</p>

                          <p>Congratulations! Based on the review of the Due diligence conducted, we are happy to inform you that
                            your organisation has been accredited as our partner.
                          </p>

                          <p>
                         We welcome you to this credible group of NGO&#39;s that have been chosen from across India to be part of
                         'A movement to change lives'-Indiadonates.

                          </p>

                          <p>
                          We would encourage you now to create your own Projects and submit your proposal. You are expected
                            to create at least one project within the next 15 days.

                          </p>

                          <p>
                          We request you to follow the &quot;Proposal templates&quot; as you frame your proposal. Our team will be
                         sharing you the proposal template.

                          </p>

                          <p>Please read carefully & keep your Login details safe!</p>

                           <p>For your reference, your login detail are as follows:</p>
                        </td>
                      </tr>
                      <tr>
                        <td style='padding-bottom: 10px;'></td>
                      ...
                      <tr>
                        <td>
                          <p class='bottom_regards'>For any questions and clarifications, feel free to contact us at info@indiadonates.in</p>
            ...
            <?php
                ...
                <?php
                  ...
                  <center>
                  <form method="post">
                    <button class="btn_ngo_approve" name="approve" value="yes">Approve</button>
                    <!-- <button class="btn_ngo_reject" name="reject" value="no">Reject</button> -->

                    <input class="btn_ngo_approve" type='button' id='btn' value='Print' onclick='printDiv();' style="width: 15%;height: 45px;">
					           <button type="button" class="btn_ngo_approve" style="background:#16426B" data-toggle="modal" data-target="#myModal">Re-Submit</button>
					           <button type="button" class="btn_ngo_reject"  data-toggle="modal" data-target="#myRejectModal">Reject </button>

                     <button type="button" id="btnSendMailDueDiliA" class="btn_ngo_approve" style="background:#16426B">Due- Diligence</button>
 ...
 function tbs_thankyou_page(){
    ...
    <?php
      ...
      // $_narrative_msg = get_user_meta( get_current_user_id(), '_narrative_msg', true );
       ...
       if($result_arr->ngo_done==3){
         ?>
         <div id="th_wrapper" >

           <h3 class="th_subhead">

           Your profile is under due Deligece process . inform you shortly
...
if($result_arr->ngo_done==2){
  ?>
  <div id="th_wrapper" >

    <h3 class="th_subhead">

    Thanks for Re-submission . Our team will inform your on email further.
  ...
  <?php
       ...
       if($result_arr->ngo_done==0){
         ?>
         <div id="th_wrapper" >

           <h3 class="th_subhead">

           Our Team review your information, please fill or submit these information is as below.
           ...
           <table>
             <tr>
               <td>
                    <p><h6><?php echo $result_arr->re_submit_info;  ?></h6></p>
               </td>
             </tr>
           </table>
           <hr>
         ...
         if(isset($print->ngo_resubmit_at)){
           ?>
           <div id="th_wrapper" >
             <h1 class="th_h1">
               Thank you!
           ...
           <?php
             ...
             //more information when all done
         }
...
//  wp_enqueue_script('boot-grid-databaserrr', '  https://code.jquery.com/jquery-3.3.1.js');
  wp_enqueue_script('boot-grid-database', 'https://cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js');
    wp_enqueue_script('boot-grid-database-header', 'https://cdn.datatables.net/fixedheader/3.1.5/js/dataTables.fixedHeader.min.js');
  //  wp_enqueue_script('boot-grid-database-heade4r', 'https://cdn.datatables.net/r/dt/jq-2.1.4,jszip-2.5.0,pdfmake-0.1.18,dt-1.10.9,af-2.0.0,b-1.0.3,b-colvis-1.0.3,b-html5-1.0.3,b-print-1.0.3,se-1.0.1/datatables.min.js');

    wp_enqueue_script('boot-grid-database-header44', 'https://cdn.datatables.net/buttons/1.5.6/js/dataTables.buttons.min.js');
    wp_enqueue_script('boot-grid-database-header5', 'https://cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js');
    wp_enqueue_script('boot-grid-database-header54', 'https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/pdfmake.min.js');
    wp_enqueue_script('boot-grid-database-header4', 'https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/vfs_fonts.js');
    wp_enqueue_script('boot-grid-database-header3', 'https://cdn.datatables.net/buttons/1.5.6/js/buttons.html5.min.js');
...
//
  ...
  if( admin_url('/admin.php?page=ngo_user_details') == $actual_link ) {
    wp_enqueue_script('tbs-bootstrapjs', 'https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js');
    wp_enqueue_script('boot-grid', 'https://cdnjs.cloudflare.com/ajax/libs/jquery-bootgrid/1.3.1/jquery.bootgrid.min.js');
...
function tbs_common_admin_styles() {
  ...
  $actual_link = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
  if( admin_url('/admin.php?page=ngo_profile_form') == $actual_link || admin_url('/admin.php?page=ngo_user_details') == $actual_link ) {
      ...
      wp_enqueue_style('boot-gridstyles-dataTables','https://cdn.datatables.net/1.10.19/css/jquery.dataTables.min.css');
      wp_enqueue_style('boot-gridstyles-database-header','https://cdn.datatables.net/fixedheader/3.1.5/css/fixedHeader.dataTables.min.css');
      wp_enqueue_style('boot-gridstyles-database-heade5r','https://cdn.datatables.net/r/dt/jq-2.1.4,jszip-2.5.0,pdfmake-0.1.18,dt-1.10.9,af-2.0.0,b-1.0.3,b-colvis-1.0.3,b-html5-1.0.3,b-print-1.0.3,se-1.0.1/datatables.min.css');
...
add_action("wp_ajax_ajdataNGOReject","ajdataNGOReject");
add_action( 'wp_ajax_nopriv_ajdataNGOReject', 'ajdataNGOReject' );





add_action("wp_ajax_ajdata_support","ajdata_support");
add_action( 'wp_ajax_nopriv_ajdata_support', 'ajdata_support' );


//reject ngo email send
function ajdataNGOReject(){
  ...
  $table_name = "wp_ngo_profile";
  $result_arr = $wpdb->get_row( "SELECT * FROM $table_name where nguser_id = '$usid'" );
  $user_pre_name = get_user_meta( $usid, 'user_prefix_name', true );
  $user_last_name = get_user_meta(  $usid, 'user_last_name', true );

  $userName=$user_pre_name." ".$user_last_name;
  $userName1=$user_last_name;
  ...
  $body = file_get_contents(plugin_dir_url( __FILE__ ) . 'email/ngoreject_email.php');
  //$body = str_replace('{{--msgName--}}', $org_name, $body);
  $body = str_replace('{{--user_email--}}', $ngoEmail, $body);
  $body = str_replace('{{--user_password--}}', $ngo_user_temp_pass, $body);
  $body = str_replace('{{--userName--}}', $userName1, $body);
  $body = str_replace('{{--msgdata--}}', $msg_data, $body);




  $subject = 'NGO Rejection';
...
function ajdata_support(){
$ng_id=$_POST['ng_id'];
global $wpdb;
$table_name = "wp_ngo_support";
$mylink = $wpdb->get_row( "SELECT * FROM $table_name WHERE id = $ng_id" );
echo json_encode($mylink);
exit();

}


add_action("wp_ajax_ajdata_duedili","ajdata_duedili");
add_action( 'wp_ajax_nopriv_ajdata_duedili', 'ajdata_duedili' );

function ajdata_duedili(){
...
$userName1=$user_last_name;
   ...
   $ngo_user_temp_pass = get_user_meta( $usid, 'vikkip', true );
   $saltdd = $usid.$ngoEmail;
   $awesome_level = md5($saltdd);

   $password_rset_link = home_url('/login/change-password/?daata='.$awesome_level.'&d1='.$usid);
...
$body = file_get_contents(plugin_dir_url( __FILE__ ) . 'email/duedeli_email.php');
//$body = str_replace('{{--msgName--}}', $org_name, $body);
$body = str_replace('{{--user_email--}}', $ngoEmail, $body);
$body = str_replace('{{--user_password--}}', $ngo_user_temp_pass, $body);
$body = str_replace('{{--userName--}}', $userName1, $body);
$body = str_replace('{{--passwordLink--}}', $password_rset_link, $body);



$subject = 'Due- Diligence Verification';
...
$subject = 'Complete your Registration formalities in Indiadonates';
...
function select_cityf2(){
 ...
 function tbs_create_ngo_pages_on_success(){
  ...
  <div class="modal fade" id="myDueModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Due- Diligence Message</h4>
        </div>
        <div class="modal-body">
	      <textarea class="form-control" rows="5" id="txtNarativeDUE" name="msgdataDUE" Placeholder="" required></textarea><br/>
	      <input type="button" name="subb" id="btnSendMailDueDili" value="Submit"class="btn" >
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
  ...
  <div class="modal fade" id="myRejectModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">NGO Rejection</h4>
        </div>
        <div class="modal-body">
	      <textarea class="form-control" placeholder="Enter Reason for Rejection" rows="5" id="txtRejectionReason" name="msgdataDUE" Placeholder="" required></textarea><br/>
	      <input type="button" name="subb" id="btnSendMailRejection" value="Submit"class="btn" >
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
