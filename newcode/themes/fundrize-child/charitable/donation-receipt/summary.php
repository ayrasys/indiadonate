...
<td style="height: 41px;" colspan="4">80G certificate No. DIT(E)/2012-2013/ 887 Dt. 08/02/2013 under Section 80G of income Tax Act  <br>
with perpetual validity</td>
</tr>
<tr style="height: 21px;">
<td style="height: 21px;"><b>Donation Receipt<b></td>
...
<table width="619" border="2">
  ...
  <tr>
    <td colspan="4"><p>80G certificate No. DIT(E)/2012-2013/ 887 Dt.  08/02/2013 under Section 80G of income Tax Act <br> with perpetual validity</p></td>

  </tr>
   <tr>
    <td width="167"><b>Donation Receipt</b></td>
    <td width="118"></td>
    <td width="140"></td>
    <td width="164"></td>
  </tr>
...
';
    ...
    <table class="tg">
      <tr>
        <td class="tg-0pky">
          <img src="https://indiadonates.in/wp-content/uploads/2019/01/DevPro-final-logo.jpg" width="100">
        </td>
        <td class="tg-0pky" colspan="3">
          Reg. Off: 113A, Pocket A, DDA Flats, Sukdev Vihar<br>
          Delhi-110025<br>
          Phone: 011-46150777 <br>
          PAN:AAATD3420D
        </td>
    ...
    <tr>
      <td class="tg-0pky"><span style="font-weight:bold">Reciept No</span></td>
      <td class="tg-0pky">'.$rn_no.'</td>
      <td class="tg-0pky"><span style="font-weight:bold">Donation Recieved on</span></td>
      <td class="tg-0pky">'.$cdate.'</td>
    </tr>
    <tr>
      <td class="tg-0pky" colspan="4">80G certificate No. DIT(E)/2012-2013/ 887 Dt.  08/02/2013 under Section 80G of income Tax Act with perpetual validity</td>
    </tr>
    <tr>
      <td class="tg-c3ow" colspan="4"><span style="font-weight:bold">Donation Receipt</span></td>
    </tr>
    <tr>
      <td class="tg-0pky" colspan="2"><span style="font-weight:bold">Full Name</span></td>
      <td class="tg-0pky" colspan="2">'.$userTitle.'</td>
    </tr>
    <tr>
      <td class="tg-0pky" colspan="2"><span style="font-weight:bold">Address</span></td>
      <td class="tg-0pky" colspan="2">'.$city.' - '.$pincode_aj.'</td>
    </tr>
    <tr>
      <td class="tg-0pky" colspan="2"><span style="font-weight:bold">Email ID</span></td>
      <td class="tg-0pky" colspan="2">'.$get_email_id.'</td>
    </tr>
    <tr>
      <td class="tg-0pky" colspan="2"><span style="font-weight:bold">Phone</span></td>
      <td class="tg-0pky" colspan="2">'.$phonneaj.'</td>
    </tr>
    <tr>
      <td class="tg-0pky" colspan="2"><span style="font-weight:bold">Permanent Account Number</span></td>
      <td class="tg-0pky" colspan="2"></td>
    </tr>
    <tr>
      <td class="tg-0pky" colspan="2"><span style="font-weight:bold">Donation Amount</span></td>
      <td class="tg-0pky" colspan="2">'.$new_amn.'</td>
    </tr>
    <tr>
      <td class="tg-0pky" colspan="2"><span style="font-weight:bold">Amount in Words</span></td>
      <td class="tg-0pky" colspan="2">'.$rsword.'</td>
    </tr>
    <tr>
      <td class="tg-0pky" colspan="2"><span style="font-weight:bold">Instrument Type</span></td>
      <td class="tg-0pky" colspan="2"></td>
    </tr>
    <tr>
      <td class="tg-0pky" colspan="4"><span style="font-weight:bold">Instrument Ref. Number  &amp; Date </span>        -NA- / 24-Apr-2018</td>
    </tr>
    <tr>
      <td class="tg-0pky" colspan="4">Thank You Supporting Indiadonates</td>
    </tr>
    <tr>
      <td class="tg-0pky" colspan="4">404, White House, 382 , Sant Nagar ,East of Kailash, Delhi- 110065</td>
    </tr>
    <tr>
      <td class="tg-0pky" colspan="4">PAN : AAATD3420B</td>
    </tr>
    ...
    <tr>
      ...
      <td class="tg-0pky" colspan="3">
       <span style="font-weight:bold;color:rgb(254, 0, 0)">Note: </span>This is a computer  generated receipt and does not require a signature.
      </td>
      <td class="tg-0pky">
        <img src="https://indiadonates.in/wp-content/uploads/2018/12/india-donates-1024x344.png" width="100">
      </td>
...
file_put_contents("paymentDoc.pdf", $output);
...
$pdf->WriteHTML($ajhtml);
	...
	//  $donation_reciept_path = WP_CONTENT_DIR.'/uploads/donation-reciept/'.$rn_no.'-donation.pdf';
	  $donation_reciept_path="paymentDoc.pdf";
