            ...
            <div id="inner-content" class="inner-content-wrap">
				...
				$ngo_url = $new_ngo_url->user_login;
                    ...
                    <div class="single-content">
                            ...
                            <!-- Tab 5 -->
                            <input type="radio" name="tabset-lxa" id="tab1" aria-controls="marzen-lxa" style="display: none;">
                            <label for="tab1">Report</label>
                            ...
                            <div class="tab-panellxslx">
                                ...
                                <section id="marzen-lxa" class="tab-panellx">
                                  <?php
                                  $table_name = "wp_ngo_narative";
                                  $post_id=get_the_ID();

                                  $result = $wpdb->get_results( " SELECT * FROM $table_name where ngo_id=$post_id");
                                  $i=0;
                                  foreach( $result as $printRow ){
                                    $ida=$printRow->id;

                                    $i++;
                                    $flink=wp_get_attachment_link( $printRow->project_attchment, 'thumbnail', true);
